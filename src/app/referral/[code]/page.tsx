...
export default function ReferralPage({
  ...
  const handleSignUp = () => {
    const signupUrl = `/signup?referral_code=${encodeURIComponent(referralCode)}`;
  ...
  const benefits = [
    { title: "Get 20% discount", description: "On your first project with this freelancer", icon: "💰" },
    { title: "Risk-free trial", description: "If you're not satisfied, we offer a full refund", icon: "✓" },
    { title: "Dedicated support", description: "Our team ensures a smooth collaboration", icon: "🎯" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <Link href="/" className="text-2xl font-bold text-blue-600">ScopePad</Link>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Meet {freelancer.name}</h1>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="text-right">
                  <p className="font-semibold text-gray-900">${freelancer.hourlyRate}/hr</p>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {freelancer.services.map((service, i) => (
                    <span key={i} className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">{service}</span>
                  ))}
                </div>
              </div>
              {freelancer.testimonials.length > 0 && (
                <div className="border-t border-gray-200 pt-6">
                  <h3 className="font-semibold text-gray-900 mb-4">Client Testimonials</h3>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 sticky top-4">
              <div className="mb-6">
                <div className="text-center mb-4">
                  <p className="text-sm text-gray-600 mb-1">Special Referral Offer</p>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { step: 1, title: "Sign Up", description: "Create your ScopePad account with the referral code" },
              { step: 2, title: "Create Project", description: "Post your project details and requirements" },
              { step: 3, title: "Get 20% Discount", description: "Your discount applies automatically to first invoice" },
            ].map((item) => (
